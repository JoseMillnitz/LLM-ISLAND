# LLM Island System — Specification v0.3-rc2
...
| Edit `connections.llmainland` | This file — MAINLAND FILE STRUCTURE |
| Decide what update tier a change requires | This file — UPDATE TIERS |
| Resume or start a propagation cascade | This file — PROPAGATION STATE AND RESUME |
| Validate an island (rules, status, staleness) | This file — VALIDITY RULES + STALENESS DETECTION |
...
The `SPEC/` table is in `SPEC/README.md`. More sections move into
`SPEC/` in v0.3-rc3 and v0.3-rc4 — the table here will shrink as they
do.
